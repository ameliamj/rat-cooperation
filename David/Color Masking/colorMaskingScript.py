...
def normalize_video(
    ...
    while True:
        ...
        threshold_near = threshold + 5  # Threshold for pixels near previously colored pixels
...
if __name__ == "__main__":
    ...
    shade4 = [250, 244, 195]     #yellow collar (15, 22)
    shade5 = [37, 140, 253]     #blue collar
    ...
    normalize_video(
        input_path="/Users/david/Documents/Research/Saxena Lab/Color Masking/RedandYellow_dyedfailed.mp4",
        output_path="/Users/david/Documents/Research/Saxena Lab/Color Masking/ry_dyedbad_sample.mp4",
        color1_rgb=shade8,
        color1_rgb2 = shade8b,
        color2_rgb=shade9,
        color2_rgb2 = shade9b,
